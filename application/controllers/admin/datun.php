...
class Datun extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data=array(
            'data' =>$this->db->get_where('tb_berita',array('kat_berita'=>'perdata dan tata usaha negara'))->result_array()
        );
        $this->load->view('admin/datun/data',$data);
    }
    ...
    public function upload(){
        ...
        if($this->upload->do_upload('file')){
            ...
            $simpan = array(
                ...
                'ket_file'  => "sementara",
                'tgl_file'  => date('Y-m-d'),
                'kat_file' =>'perdata dan tata usaha negara'
            );
    ...
    public function hapus(){
        ...
        $where['kat_file']="perdata dan tata usaha negara";
