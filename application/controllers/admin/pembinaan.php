...
class Pembinaan extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data=array(
            'data' =>$this->db->get_where('tb_berita',array('kat_berita'=>'pembinaan'))->result_array()
        );
        $this->load->view('admin/pembinaan/data',$data);
    }
