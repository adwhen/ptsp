...
class Pengawasan extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data=array(
            'data' =>$this->db->get_where('tb_berita',array('kat_berita'=>'pengawasan'))->result_array()
        );
        $this->load->view('admin/pengawasan/data',$data);
    }
