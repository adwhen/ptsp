...
class Pengawasan extends CI_Controller {
	...
	{      
        $data=array(
			'isi'=>'admin/pengawasan/data',
			'data' => $this->db->get_where('tb_file',array('kat_file'=>'pengawasan'))->result_array()
		);
	...
	public function hapus(){
		...
		$galeri=$this->Mgaleri->pengawasan();
		$data= array(
