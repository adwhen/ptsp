    ...
    <section class="invoice">
      <div class="row">
        <div class="col-xs-12">
          <ol class="breadcrumb" style="font-size: 15px">
            ...
            <li class="active"> INFORMASI INTELIJEN</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-6 invoice-col" style="text-align: right;">
          <a href="<?php echo base_url('admin/intelijen/form');?>">
      ...
      <div style="width: 100%;background-color: #edf2f0;color: white;height: 25px;text-align: center;vertical-align: center;">
          <h3 style="font-size: 20px;color: #3e3f3f;"><center><strong>INFORMASI INTELIJEN</strong></center></h3>    
      </div> <br>
      <div class="row">
                ...
                <td>
                  <center>
                    <div class="tooltip-demo">
                      <a href="<?php echo base_url('admin/intelijen/form/'.$this->Mcrypt->encrypt($dt['id_informasi']));?>">
                      ...
                      <button onclick="modal_hapus('<?php echo $no; ?>','<?php echo $this->Mcrypt->encrypt($dt['id_informasi']) ?>')" data-balloon="Hapus" data-balloon-pos="up" data-toggle="modal" data-target="#hapus-intelijen" class="btn btn-danger" title="Hapus"><i class="fa fa-trash"></i></button>
                      </a>
                    </div>
                  </center>
                </td>
...
<div class="modal modal-danger fade" id="hapus-intelijen">
  <?php  echo form_open_multipart('admin/intelijen/hapus/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'hapusPeraturan')); ?>
