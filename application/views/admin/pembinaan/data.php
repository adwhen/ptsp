    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-6 invoice-col" style="text-align: right;">
          <a href="<?php echo base_url('admin/pembinaan/form');?>">
                ...
                <td>
                  <center>
                    <div class="tooltip-demo">
                      ...
                      <a href="<?php echo base_url('admin/pembinaan/form/'.$this->Mcrypt->encrypt($dt['id_berita']));?>">
...
<div class="modal modal-danger fade" id="hapus-berita">
  <?php  echo form_open_multipart('admin/pembinaan/hapus/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'hapusPeraturan')); ?>
