<div class="content-wrapper">
    ...
    <section class="invoice">
      <div class="row">
        <div class="col-xs-12">
          <ol class="breadcrumb" style="font-size: 15px">
            ...
            <li class="active"> INFORMASI PENGADAAN</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div style="width: 100%;background-color: #edf2f0;color: white;height: 25px;text-align: center;vertical-align: center;">
          <h3 style="font-size: 20px;color: #3e3f3f;"><center><strong>INFORMASI PENGADAAN</strong></center></h3>    
      </div> <br>
      <div class="row">
                ...
                <td>
                  <center>
                    <div class="tooltip-demo">
                        ...
                        <button data-balloon="Edit" data-balloon-pos="up" data-toggle="modal" data-target="#ubah_pengadaan" onclick="pengadaan_ubah('<?php echo $this->Mcrypt->encrypt($dt['id_file']);?>','<?php echo $dt['nama_file'];?>','<?php echo $dt['url_file'];?>','<?php echo $dt['kat_file'];?>','<?php echo $dt['tgl_file'] ?>')" class="btn btn-info" title="Ubah"><i class="fa fa-pencil"></i></button>

 
                        <button onclick="pengadaan_hapus('<?php echo $this->Mcrypt->encrypt($dt['id_file']);?>','<?php echo $dt['nama_file'];?>','<?php echo $dt['url_file'];?>','<?php echo $dt['kat_file'];?>','<?php echo $dt['tgl_file'] ?>')" data-balloon="Hapus" data-balloon-pos="up" data-toggle="modal" data-target="#hapus_pengadaan" class="btn btn-danger" title="Hapus"><i class="fa fa-trash"></i></button>
...
<script type="text/javascript">
  function pengadaan_ubah(id_file,nama_file,url_file,kat_file,tgl_file) {
...
<script type="text/javascript">
function pengadaan_hapus(id_file,nama_file,url_file,kat_file,tgl_file) {
...
<div class="modal fade" id="tambah_pengadaan">
  <?php  echo form_open_multipart('admin/pengadaan/tambah/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'tambahData')); ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Tambah pengadaan Foto</h4>
              </div>
...
<div class="modal modal-primary fade" id="ubah_pengadaan">
         <?php  echo form_open_multipart('admin/pengadaan/ubah/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'ubahData')); ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal modal-danger fade" id="hapus_pengadaan">
  <?php  echo form_open_multipart('admin/pengadaan/hapus/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'hapusData')); ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
