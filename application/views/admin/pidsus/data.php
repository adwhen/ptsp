    ...
    <section class="invoice">
      <div class="row">
        <div class="col-xs-12">
          <ol class="breadcrumb" style="font-size: 15px">
            ...
            <li class="active"> INFORMASI PIDANA KHUSUS</li>
          </ol>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-6 invoice-col" style="text-align: right;">   
          <button type="button" class="btn btn-default" data-toggle="modal" data-target="#tambah_pidsus">
                Tambah Data
          </button>
        </div>
        <p class="loading"></p>
      ...
      <div style="width: 100%;background-color: #edf2f0;color: white;height: 25px;text-align: center;vertical-align: center;">
          <h3 style="font-size: 20px;color: #3e3f3f;"><center><strong>INFORMASI PIDANA KHUSUS</strong></center></h3>    
      </div> <br>
      <div class="row">
                ...
                <td>
                  <center>
                    <div class="tooltip-demo">
                        ...
                        <button data-balloon="Edit" data-balloon-pos="up" data-toggle="modal" data-target="#ubah_pidsus" onclick="pidsus_ubah('<?php echo $this->Mcrypt->encrypt($dt['id_file']);?>','<?php echo $dt['nama_file'];?>','<?php echo $dt['url_file'];?>','<?php echo $dt['kat_file'];?>','<?php echo $dt['tgl_file'] ?>')" class="btn btn-info" title="Ubah"><i class="fa fa-pencil"></i></button>

 
                        <button onclick="pidsus_hapus('<?php echo $this->Mcrypt->encrypt($dt['id_file']);?>','<?php echo $dt['nama_file'];?>','<?php echo $dt['url_file'];?>','<?php echo $dt['kat_file'];?>','<?php echo $dt['tgl_file'] ?>')" data-balloon="Hapus" data-balloon-pos="up" data-toggle="modal" data-target="#hapus_pidsus" class="btn btn-danger" title="Hapus"><i class="fa fa-trash"></i></button>
...
<script type="text/javascript">
  function pidsus_ubah(id_file,nama_file,url_file,kat_file,tgl_file) {
...
<script type="text/javascript">
function pidsus_hapus(id_file,nama_file,url_file,kat_file,tgl_file) {
...
<div class="modal fade" id="tambah_pidsus">
  <?php  echo form_open_multipart('admin/pidsus/tambah/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'tambahData')); ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Tambah pidsus Foto</h4>
              </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-9">
                     <select class="form-control" name="kat_file" id="kat_file" required="">
                        <option value="pidana khusus">pidsus</option>
                      </select>
                    </div>
                </div>  
              </div>
...
<div class="modal modal-primary fade" id="ubah_pidsus">
         <?php  echo form_open_multipart('admin/pidsus/ubah/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'ubahData')); ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal modal-danger fade" id="hapus_pidsus">
  <?php  echo form_open_multipart('admin/pidsus/hapus/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'hapusData')); ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">HAPUS PIDANA KHUSUS</h4>
              </div>
              <div class="modal-body">
