    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-6 invoice-col" style="text-align: right;">
          <a href="<?php echo base_url('admin/pidsus/form');?>">
      ...
      <div style="width: 100%;background-color: #edf2f0;color: white;height: 25px;text-align: center;vertical-align: center;">
          <h3 style="font-size: 20px;color: #3e3f3f;"><center><strong>PIDANA KHUSUS</strong></center></h3>    
      </div> <br>
      <div class="row">
                ...
                <td>
                  <center>
                    <div class="tooltip-demo">
                      ...
                      <a href="<?php echo base_url('admin/pidsus/form/'.$this->Mcrypt->encrypt($dt['id_berita']));?>">
...
<div class="modal modal-danger fade" id="hapus-berita">
  <?php  echo form_open_multipart('admin/pidsus/hapus/',array('class'=>"form-horizontal",'method'=>'POST','id'=>'hapusPeraturan')); ?>
