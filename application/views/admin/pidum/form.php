...
<?php $list=$this->db->query('SELECT * FROM tb_informasi  where kat_informasi="pidana umum" group by judul_informasi')->result_array();?>
    ...
    <div class="col-md-12">
        <section class="invoice">
          ...
          <div class="row invoice-info">
            ...
            <?php  echo form_open_multipart('admin/pidum/form/',array('class'=>"form-horizontal",'method'=>'POST')); ?>
