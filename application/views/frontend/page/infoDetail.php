...
<div class="container-fluid" style="text-align:center;width:75%">
    <img src="<?php echo url_serv($data[0]['cover_berita'])?>" class="img-fluid" style="text-align:center" alt="Responsive image">
</div>
<br>
...
<div class="container-fluid" style="width:75%">
    <center>
    <h5 style="font-size: 25px;">INFORMASI <?php echo strtoupper($judul); ?> TERKAIT</h5>
    <br>
