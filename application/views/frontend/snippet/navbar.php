<div class="container col-sm-12" id="berita1">
    <div class="row" style="margin-left:10px">
        <br>
        <h3 class="text-center text-white"><img src="<?php echo base_url('/asset/assets_front') ?>/img/logoatas.png" style="margin-top:15px;height:70%;"></h3>
    </div>
</div>
<div class="container col-sm-12">
    <nav class="navbar navbar-expand-md navbar-light" id="navbarBerita">
        <a class="navbar-brand" href="#">
            <img style="height: 30px;" src="#" alt="" id="myLogo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item" style="margin-right:20px">
                    <a class="nav-link menuNav" href="<?php echo base_url('frontend/beranda');?>">Menu</a>
                </li>
                ...
                <li class="nav-item" style="margin-right:20px">
                    <a class="nav-link menuNav" href="<?php echo base_url('frontend/berita');?>">Berita</a>
                </li>
                <li class="nav-item" style="margin-right:20px">
                    <a class="nav-link menuNav" href="<?php echo base_url('frontend/galeri');?>">Galeri</a>
                </li>
                <li class="nav-item" style="margin-right:20px">
